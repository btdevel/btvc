...
const materials = {
  ...
  "#": [makeMaterial({map: gateImg, alphaMap: gateAlpha, doubleSide: false}), null, makeMaterial({
    map: gate2Img,
    alphaMap: gate2Alpha,
    doubleSide: false
  })],
...
function Wall({face, type}) {
  ...
  return (<mesh rotation-order="ZXY" rotation={[pi2, 0, face * pi2]} position={[x, y, z]} {...props} geometry={geom}
                material={mat}/>)
}
